  ...
  return (
    <PageWrapper>
      <div className="pt-[70px] pb-[200px] px-[15%] font-maruburi">
        <div className="flex items-center">
          ...
          <div className="font-maruburi-bold">
            <div className="overflow-hidden">
              <motion.h1
                className="text-aro-blue text-[30px] mt-[60px]"
                initial={{ y: 40 }}
                whileInView={{
                  y: 0,
            ...
            <div className="overflow-hidden">
              <motion.h2
                className="text-2xl font-semibold mt-[30px] leading-9"
                initial={{ y: 70 }}
                whileInView={{
                  y: 0,
        ...
        <div>
          <motion.p
            className="mt-[20px] text-gray-6 text-[20px] leading-10"
            initial={{ opacity: 0 }}
            whileInView={{
              opacity: 1,
              transition: { delay: 1, duration: 1, stiffness: 10 },
            }}
            viewport={{ once: true }}
          >
            안녕하십니까? <br />
            ...
            광범위한 건설 영역에 대해 작업하고 있는 전문 업체 입니다. 2021년
            회사 설립 후 고객만족이라는 목표 아래 최선을 다해왔습니다.
            <br />
            ...
            <br />
            <br />
            다시 한번, 저희 <strong>아르오</strong>를 찾아주셔서 감사합니다.
          </motion.p>
